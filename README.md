...
<div align="center">
  ...
  <img src="https://img.shields.io/github/followers/issatheblows?style=for-the-badge&logo=github&logoColor=ffffff&color=111111&labelColor=111111&label=followers" alt="followers">
  <img src="https://komarev.com/ghpvc/?username=issatheblows&style=for-the-badge&color=eaeaea&label=profile+views&labelColor=111111" alt="profile views">
</div>
...
```ts
const issa = {
  writes:  ["Grok", "Claude", "bots that keep a spine"],     // on X, @issatheblows
  builds:  ["agent loops", "markdown brains", "harnesses you can rerun"],
  rules:   ["one source of truth", "memory over vibes", "ship the boring layer first"],
  now:     "wiring Grok + Claude into a bot that runs without me in the room",
  learns:  "by breaking the loop, then writing the rule that stops it",
};
```
